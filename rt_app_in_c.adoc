...
U16 checkCounter(U16 i) { return i+1; }

U16 checkGray(U16 i) { // parity-enhanced Gray counter
  U16 msb = x&~(x-1); return i^((msb<<1)|1); }
// parity-enhanced Gray code is Gray||parity(Gray), always odd parity

U16 checkLfsr(U16 i) { // Metcalf xorshift, period==65535
  i ^= i>>7; i ^= i<<9; i ^= i>>13; return i; }
...
U16 checkAlu(U16 i) {
  return (i*nonTrivMult+i*nonTrivId+coprime)%modulus; }
...
extern void appInit(); extern void appOnce();
